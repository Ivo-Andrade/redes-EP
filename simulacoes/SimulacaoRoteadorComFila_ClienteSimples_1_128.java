...
public class SimulacaoRoteadorComFila_ClienteSimples_1_128 
{
        ...
        throws Exception
    {
        ...
        int tamanhoDaFilaDePacotesNoRoteador = ( 128 );
        ...
        EnderecoDeMaquina servidor = 
            new EnderecoDeMaquina(
                "SimulacaoRoteadorComFila_ClienteSimples_1_128-Servidor",
        ...
        EnderecoDeMaquina roteador = 
            new EnderecoDeMaquina(
                "SimulacaoRoteadorComFila_ClienteSimples_1_128-Roteador",
                InetAddress.getLocalHost(),
                9555
            );
        ...
        EnderecoDeMaquina cliente =
            new EnderecoDeMaquina(
                "SimulacaoRoteadorComFila_ClienteSimples_1_128-Cliente",
                InetAddress.getLocalHost(),
                9111
            );
