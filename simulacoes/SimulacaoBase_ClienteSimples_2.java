...
public class SimulacaoBase_ClienteSimples_2 
{
        ...
        throws Exception
    {
        ...
        int tamanhoDaJanelaDeRepeticaoSeletiva = ( 2 );
        ...
        EnderecoDeMaquina servidor = 
            new EnderecoDeMaquina(
                "SimulacaoBase_ClienteSimples_2-Servidor",
        ...
        EnderecoDeMaquina roteador = 
            new EnderecoDeMaquina(
                "SimulacaoBase_ClienteSimples_2-Roteador",
                InetAddress.getLocalHost(),
                9555
            );
        ...
        EnderecoDeMaquina cliente =
            new EnderecoDeMaquina(
                "SimulacaoBase_ClienteSimples_2-Cliente",
                InetAddress.getLocalHost(),
                9111
            );
