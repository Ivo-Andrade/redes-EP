...
public class SimulacaoPerdaDePacote_ClienteSimples_1_001 
{
        ...
        throws Exception
    {
        ...
        EnderecoDeMaquina servidor = 
            new EnderecoDeMaquina(
                "SimulacaoPerdaDePacote_ClienteSimples_1_001-Servidor",
        ...
        EnderecoDeMaquina roteador = 
            new EnderecoDeMaquina(
                "SimulacaoPerdaDePacote_ClienteSimples_1_001-Roteador",
                InetAddress.getLocalHost(),
                9555
            );
        ...
        EnderecoDeMaquina cliente =
            new EnderecoDeMaquina(
                "SimulacaoPerdaDePacote_ClienteSimples_1_001-Cliente",
                InetAddress.getLocalHost(),
                9111
            );
        ...
        probabilidadesDePerda.put( 0, 0.001 );
        probabilidadesDePerda.put( 1, 0.001 );
