...
public class SimulacaoBase_SimpleClient_128
{
        ...
        throws Exception
    {
        ...
        EnderecoDeMaquina servidor = 
            new EnderecoDeMaquina(
                "simulacaoBase_singleClient_128-Servidor",
        ...
        EnderecoDeMaquina roteador = 
            new EnderecoDeMaquina(
                "simulacaoBase_singleClient_128-Roteador",
                InetAddress.getLocalHost(),
                9555
            );
        ...
        EnderecoDeMaquina cliente =
            new EnderecoDeMaquina(
                "simulacaoBase_singleClient_128-Cliente",
                InetAddress.getLocalHost(),
                9111
            );
