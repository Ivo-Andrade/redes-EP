...
public class SimulacaoAtrasoDePropagacao_ClienteSimples_1_100 
{
        ...
        throws Exception
    {
        ...
        int tamanhoDaJanelaDeRepeticaoSeletiva = ( 1 );
        ...
        EnderecoDeMaquina servidor = 
            new EnderecoDeMaquina(
                "SimulacaoAtrasoDePropagacao_ClienteSimples_1_100-Servidor",
        ...
        EnderecoDeMaquina roteador = 
            new EnderecoDeMaquina(
                "SimulacaoAtrasoDePropagacao_ClienteSimples_1_100-Roteador",
                InetAddress.getLocalHost(),
                9555
            );
        ...
        EnderecoDeMaquina cliente =
            new EnderecoDeMaquina(
                "SimulacaoAtrasoDePropagacao_ClienteSimples_1_100-Cliente",
                InetAddress.getLocalHost(),
                9111
            );
        ...
        atrasosDePropagacao.put( 0, 100 );
        atrasosDePropagacao.put( 1, 100 );
