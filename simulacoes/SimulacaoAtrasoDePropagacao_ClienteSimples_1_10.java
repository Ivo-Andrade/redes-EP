...
public class SimulacaoAtrasoDePropagacao_ClienteSimples_1_10 
{
        ...
        throws Exception
    {
        ...
        EnderecoDeMaquina servidor = 
            new EnderecoDeMaquina(
                "SimulacaoAtrasoDePropagacao_ClienteSimples_1_10-Servidor",
        ...
        EnderecoDeMaquina roteador = 
            new EnderecoDeMaquina(
                "SimulacaoAtrasoDePropagacao_ClienteSimples_1_10-Roteador",
                InetAddress.getLocalHost(),
                9555
            );
        ...
        EnderecoDeMaquina cliente =
            new EnderecoDeMaquina(
                "SimulacaoAtrasoDePropagacao_ClienteSimples_1_10-Cliente",
                InetAddress.getLocalHost(),
                9111
            );
        ...
        atrasosDePropagacao.put( 0, 10 );
        atrasosDePropagacao.put( 1, 10 );
