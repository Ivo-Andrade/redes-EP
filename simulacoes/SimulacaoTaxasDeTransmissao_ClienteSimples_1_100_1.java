...
public class SimulacaoTaxasDeTransmissao_ClienteSimples_1_100_1 
{
        ...
        throws Exception
    {
        ...
        EnderecoDeMaquina servidor = 
            new EnderecoDeMaquina(
                "SimulacaoTaxasDeTransmissao_ClienteSimples_1_100_1-Servidor",
        ...
        EnderecoDeMaquina roteador = 
            new EnderecoDeMaquina(
                "SimulacaoTaxasDeTransmissao_ClienteSimples_1_100_1-Roteador",
                InetAddress.getLocalHost(),
                9555
            );
        ...
        EnderecoDeMaquina cliente =
            new EnderecoDeMaquina(
                "SimulacaoTaxasDeTransmissao_ClienteSimples_1_100_1-Cliente",
                InetAddress.getLocalHost(),
                9111
            );
        ...
        atrasosDeTransmissao.put( 0, 100 );
