...
public class SimulacaoTaxasDeTransmissao_ClienteSimples_1_1_100 
{
        ...
        throws Exception
    {
        ...
        EnderecoDeMaquina servidor = 
            new EnderecoDeMaquina(
                "SimulacaoTaxasDeTransmissao_ClienteSimples_1_1_100-Servidor",
        ...
        EnderecoDeMaquina roteador = 
            new EnderecoDeMaquina(
                "SimulacaoTaxasDeTransmissao_ClienteSimples_1_1_100-Roteador",
                InetAddress.getLocalHost(),
                9555
            );
        ...
        EnderecoDeMaquina cliente =
            new EnderecoDeMaquina(
                "SimulacaoTaxasDeTransmissao_ClienteSimples_1_1_100-Cliente",
                InetAddress.getLocalHost(),
                9111
            );
        ...
        atrasosDeTransmissao.put( 1, 100 );
