...
public class SimulacaoBase_ClienteSimples_4 
{
        ...
        throws Exception
    {
        ...
        int tamanhoDaJanelaDeRepeticaoSeletiva = ( 4 );
        ...
        EnderecoDeMaquina servidor = 
            new EnderecoDeMaquina(
                "SimulacaoBase_ClienteSimples_4-Servidor",
        ...
        EnderecoDeMaquina roteador = 
            new EnderecoDeMaquina(
                "SimulacaoBase_ClienteSimples_4-Roteador",
                InetAddress.getLocalHost(),
                9555
            );
        ...
        EnderecoDeMaquina cliente =
            new EnderecoDeMaquina(
                "SimulacaoBase_ClienteSimples_4-Cliente",
                InetAddress.getLocalHost(),
                9111
            );
